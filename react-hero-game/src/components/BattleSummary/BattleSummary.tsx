...
const BattleSummary = ({ summaryArr }: BattleSummaryProps) => {
  return (
    <div className="w-full max-h-400 overflow-y-auto max-w-md bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 p-10 flex flex-col items-center pb-10">
